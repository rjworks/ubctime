...
const MyModal = ({show, body, button, handleClose, hasFooter, type, courseInfo}) => {
    return (
        ...
        >
            <Modal.Header className="ubc-time-modal-title">
                <Modal.Title>
                            ...
                            <div
                                ...
                                <svg
                                    ...
                                    className="
                                                    ...
                                                    border-white
                                                    hover:border-white hover:bg-blue-400 transition duration-500"
                                    version="1"
                                    viewBox="0 0 235 87">
                                    <path
            ...
            <Modal.Body>
                {body.length > 0 && (body.map((el, i) => {
                    if(typeof el !== "object") {
                        return type === "courseInfo" ?
                            <ul key={i} className="course-info">
                                <li className={i % 2 === 0 ? "course-info-even" : "course-info-odd"}>{el}</li>
                            </ul>
                            :
                            <ul key={i}>
                                <li>{el}</li>
            ...
            {hasFooter && (
                <Modal.Footer>
                    <Button className="ubc-time-modal-button" onClick={handleClose}>
                        {button}
                    </Button>
                </Modal.Footer>
            )}
