...
const sessions = ["2021 Summer", "2021 Winter"];
const Narbarr = () => {
    ...
    return (
        <Navbar bg="dark" variant="dark" expand="lg">
            {/*<Navbar.Brand href="#home">UBC Time</Navbar.Brand>*/}
            ...
            <Nav>
                ...
                <NavDropdown title={currentCampus} id="basic-nav-dropdown">
                    {campuses.map((el, i) =>
                        <NavDropdown.Item
                            key={i}
                            onClick={() => setCurrentCampus(el)}>
                ...
                <NavDropdown title={currentSession} id="basic-nav-dropdown">
                    {sessions.map((el, i) =>
                        <NavDropdown.Item
                            key={i}
                            onClick={() => setCurrentSession(el)}>
                            {/*{el === currentCampus ? null : el}*/}
                            {el}
                        </NavDropdown.Item>
                    )}
        ...
        //                         <div
        //                             key={i}
        //                             className="campus-dropdown-selection"
        //                             onClick={() => setCurrentCampus(el !== currentCampus && el)}>
        //                             {el !== currentCampus && el}
        //                         </div>
        //                 )
        //                 : null}
