...
function Navbar() {
    ...
    />
                    ...
                    <div className="hidden md:flex items-center space-x-5">
                        <a href="/"
                           className="font-semibold text-md py-1 px-4 bg-blue-800 hover:bg-blue-700 text-white
                           hover:text-white-2000 rounded transition duration-300">
                            UBC Okanagan</a>
                        <a href="/"
                           className="font-semibold py-1 px-4 bg-blue-800 hover:bg-blue-700 text-white hover:text-white-2000 rounded transition duration-300">
